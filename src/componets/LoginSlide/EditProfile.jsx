...
const UserProfile = ({ handleLoginClose }) => {
  const { user, logout, updateUserProfile } = useAuth(); // Assuming there's a function to update the user profile
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the updateUserProfile function (make sure it's available in context)
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between">
                <button
                  ...
                  disabled={isSubmitting} // Disable the button during loading
                >
                  {isSubmitting ? (
                    <FaSpinner className="animate-spin text-white" /> // Show spinner when submitting
                  ) : (
                    "Save Changes"
                  )}
                </button>
